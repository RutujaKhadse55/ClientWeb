...
import { ArrowLeft, ArrowRight, ShieldCheck, Globe, Clock, ChevronDown, ChevronUp, Sparkles, Building2 } from 'lucide-react';
import { mlmSeoArticles } from '../data/mlmSeoArticles';

const article = mlmSeoArticles.find(a => a.id === 'india-top-10-new-direct-selling-companies');

export default function IndiaNewDirectSellingPage({ onNavigate }) {
    ...
    <div className="container" style={{ padding: '40px 24px 80px', maxWidth: '1180px' }}>
      ...
      <div className="article-immersive-header">
        <button onClick={() => onNavigate('home')} className="article-back-nav">
          <ArrowLeft size={14} />
          <span>Direct Selling Journal &bull; New Direct Selling Companies India</span>
        </button>

        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '14px' }}>
          <span className="notice-badge" style={{ background: '#1A3C34', color: '#FFFFFF', fontWeight: '800' }}>DIRECT SELLING</span>
          <span className="notice-badge" style={{ background: '#8C4A52', color: '#FFFFFF', fontWeight: '800' }}>NEW ENTERPRISES 2026</span>
        </div>
        ...
        <p className="article-deck" style={{ color: '#E6EFEA', fontSize: '1.18rem', lineHeight: '1.55', marginBottom: '24px', fontFamily: 'var(--font-serif)' }}>
          New direct selling companies in India are shaping the modern retail landscape under the Consumer Protection Rules, 2021. Explore the top 10 new direct selling companies in India prioritizing authentic products, consumer satisfaction, and structured entrepreneurship.
        </p>

        <div className="article-byline">
          <span>By Direct Selling Editorial Desk</span>
          <span>&bull;</span>
      ...
      <div style={{ margin: '0 0 32px', border: '1px solid #1D2321', background: '#FFFFFF' }}>
        <img
          ...
          alt="India Top 10 New Direct Selling Companies — Modern Direct Sales Ecosystem"
        ...
        <div style={{ padding: '12px 18px', background: '#F8F5F0', borderTop: '1px solid #E2DBD2', fontSize: '0.82rem', color: '#5C6662', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px' }}>
          <span>Fig: New direct selling companies in India combine digital ordering, quality certifications, and direct consumer relationships.</span>
          <span>Source: Direct Selling Journal Industry Database</span>
        </div>
      </div>
      ...
      <div style={{ background: '#FFFFFF', border: '1px solid #1D2321', padding: '28px 32px', marginBottom: '28px', fontSize: '1.08rem', lineHeight: '1.75', color: '#1D2321' }}>
        ...
        <div style={{ marginTop: '16px', background: '#F3ECE4', border: '1px solid #E2DBD2', padding: '14px 18px', fontSize: '0.9rem', color: '#5C6662' }}>
          <strong>Legal Context:</strong> Direct selling in India is strictly regulated by the Consumer Protection (Direct Selling) Rules, 2021. Companies must maintain registered offices in India, ensure a 30-day refund policy, and operate genuine product-distribution systems free of money-circulation schemes.
        </div>
      </div>
      ...
      <div style={{ background: '#F8F5F0', border: '1px solid #E2DBD2', padding: '24px', marginBottom: '28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '14px' }}>
          <Building2 size={20} color="#8C4A52" />
          <h2 style={{ fontSize: '1.2rem', color: '#1A3C34', margin: 0, fontWeight: '800' }}>Key Features of New Indian Direct Selling Companies</h2>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '10px' }}>
          {['Digital-first ordering & app onboarding', 'FSSAI / AYUSH verified consumer products', 'Transparent retail markup commissions', 'Mandatory 30-day buyback & return policies', 'Ethical distributor development & education'].map((item, idx) => (
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ borderBottom: '3px solid #1D2321', paddingBottom: '12px', marginBottom: '24px' }}>
          <h2 className="serif-headline" style={{ fontSize: '1.9rem', color: '#1A3C34', margin: 0 }}>
            Top 10 New Direct Selling Companies in India: 2026 Editorial Selection
          </h2>
        </div>
        ...
        {article.companies.map((company) => {
          ...
          return (
            <div
              ...
              id={`direct-selling-company-${company.rank}`}
            >
              ...
              {isHgr && (
                <div style={{ marginTop: '14px', paddingTop: '14px', borderTop: '1px solid #E2DBD2', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                  <button onClick={() => onNavigate('emerging-direct-selling')} style={{ fontSize: '0.88rem', fontWeight: '700', color: '#1A3C34', textDecoration: 'underline', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
                    Read: Emerging Indian Direct Selling Company Profile →
                  </button>
                </div>
              )}
            </div>
      ...
      <div style={{ background: '#F8F5F0', border: '2px solid #1D2321', padding: '32px', marginBottom: '28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
          <ShieldCheck size={22} color="#8C4A52" />
          <h2 className="serif-headline" style={{ fontSize: '1.6rem', color: '#1A3C34', margin: 0 }}>
            Methodology: Evaluating New Direct Selling Companies in India
          </h2>
        </div>
      ...
      <div style={{ background: '#FFFFFF', border: '1px solid #E2DBD2', padding: '32px', marginBottom: '28px' }}>
        <h2 className="serif-headline" style={{ fontSize: '1.6rem', color: '#1A3C34', margin: '0 0 20px' }}>
          Frequently Asked Questions: New Direct Selling Companies in India
        </h2>
      ...
      <div style={{ background: '#F8F5F0', border: '1px solid #E2DBD2', padding: '20px 24px', fontSize: '0.85rem', color: '#5C6662', lineHeight: '1.6', marginBottom: '32px' }}>
        ...
        This guide to new direct selling companies in India is an independent editorial compilation. Inclusion does not imply official government accreditation, certification under any specific ministry, or financial ranking. HGR Corporation is included at position #10 as an example of a newer-generation Indian direct selling enterprise. Prospective participants must conduct independent due diligence under the Consumer Protection (Direct Selling) Rules, 2021 before making business or purchasing decisions.
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '2px solid #1D2321', paddingTop: '24px', flexWrap: 'wrap', gap: '14px' }}>
        ...
        >
          <span>← Read Previous: Fast Growing MLM Companies in India</span>
        </button>
        <button
          className="btn-card-action"
        ...
        >
          <span>All Top 10 Indian MLM Rankings →</span>
          <ArrowRight size={15} />
        </button>
      </div>
    </div>
